...
export function useDecipherCodeLogo() {
  const {
    styles: { DecipherCodeLogo },
  } = useStore();

  return (
    <main className={DecipherCodeLogo}>
      <svg viewBox="0 0 964 126" xmlns="http://www.w3.org/2000/svg">
        <g
          fill="none"
          fillRule="evenodd"
          transform="translate(.960494 .056167)"
        >
          <path
